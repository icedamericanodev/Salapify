...
3. One design hand. One accent colour, one type family, one card shape, one
   ...
   bug.
4. Light first. Hapon, the warm peach look, is the reference; every screen
...
| Four colour themes and the appearance studio | One theme, Hapon with Gabi as its dark option. More themes are a feature for other people, later. |
