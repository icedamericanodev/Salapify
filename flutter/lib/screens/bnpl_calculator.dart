...
class _BnplCalculatorScreenState extends State<BnplCalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final sameRounded = _m(r['totalPaid'] as double) == _m(r['cash'] as double);
    final paidText = sameRounded
        ? _mc(r['totalPaid'] as double)
        : _m(r['totalPaid'] as double);
    final cashText = sameRounded
        ? _mc(r['cash'] as double)
        : _m(r['cash'] as double);
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Installment true cost')),
      body: SafeArea(
        child: ListView(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'TRUE COST',
                        style: TextStyle(
                          color: trulyFree ? Barako.muted : Barako.warning,
                          fontSize: 11,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 2,
                        ),
