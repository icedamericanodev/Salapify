...
class _SalaryCalculatorScreenState extends State<SalaryCalculatorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final r = takeHomePay(
      basicNum,
      taxableAllowance: taxAllowNum,
      nonTaxableAllowance: nonTaxAllowNum,
    );

    // The engine works in monthly pesos; only the displayed figures scale.
    final factor = period == 'cutoff'
        ? 0.5
        : period == 'year'
        ? 12.0
        : 1.0;
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _line('PhilHealth', '- ${ms(r['philhealth'] as double)}'),
