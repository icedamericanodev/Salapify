...
const _forestDark = BarakoPalette(
  ...
  warning: Color(0xFFE8785A),
  warningStrong: Color(0xFFD95B3C),
  onPrimary: Color(0xFF3A1E07),
  celebrate: Color(0xFFFFE3C2),
...
const _forestLight = BarakoPalette(
  ...
  faint: Color(0xFF7B7367),
  warning: Color(0xFFA6402C),
  warningStrong: Color(0xFF86311F),
  onPrimary: Color(0xFFFFFFFF),
...
const List<BarakoTheme> barakoThemes = [
  ...
  BarakoTheme(key: 'mint', label: '🌿 Mint', hint: 'A glowing green.',
