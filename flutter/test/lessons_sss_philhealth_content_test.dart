...
void main() {
  group('registration', () {
    test('protect_your_future carries both Insurance Decoded and SSS & '
        'PhilHealth Essentials, exactly one group each', () {
    ...
    test('publishedLearningPaths is still exactly the two real paths', () {
    ...
    test('lessonsForPath returns Insurance Decoded followed by SSS & '
        'PhilHealth Essentials, twelve lessons total', () {
