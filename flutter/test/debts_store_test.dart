...
void main() {
  ...
  test(
    'saveDebt creates, validates, and follows the interest clock rule',
    () async {
  ...
  test(
    'payment flow: debit, payment row, record rows, payoff, delete',
    () async {
      final store = await loaded();
      ...
      final pays = (store.data['payments'] as List)
          .cast<Map<String, dynamic>>();
      ...
      final after = (store.data['debts'] as List)
          .cast<Map<String, dynamic>>()
          .single;
      ...
      await expectLater(
        store.logDebtPayment('debt1', '100', 'acct1'),
