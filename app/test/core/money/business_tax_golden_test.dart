...
void main() {
  ...
  group('sole proprietorship, non VAT', () {
    vector(
      ...
      EntityType.soleProp, VatStatus.nonVat, TaxRegime.eightPercent,
      nti: 2750000, incomeTax: 220000, businessTax: 0, netIncome: 980000,
      forms: <String>['BIR Form 1701Q', 'BIR Form 1701/1701A'],
    );
    vector(
      'OSD deducts 40 percent of GROSS SALES',
      EntityType.soleProp, VatStatus.nonVat, TaxRegime.graduatedOsd,
      nti: 1800000, incomeTax: 352500, businessTax: 90000, netIncome: 757500,
      forms: <String>['BIR Form 1701Q', 'BIR Form 1701/1701A', 'BIR Form 2551Q'],
    );
    vector(
      'itemized deducts opex AND the percentage tax itself',
      EntityType.soleProp, VatStatus.nonVat, TaxRegime.graduatedItemized,
      nti: 1110000, incomeTax: 180000, businessTax: 90000, netIncome: 930000,
      forms: <String>['BIR Form 1701Q', 'BIR Form 1701/1701A', 'BIR Form 2551Q'],
    );
  });
  ...
  group('sole proprietorship, VAT registered', () {
    vector(
      ...
      EntityType.soleProp, VatStatus.vat, TaxRegime.graduatedItemized,
      nti: 1200000, incomeTax: 202500, businessTax: 0, netIncome: 997500,
      forms: <String>['BIR Form 1701Q', 'BIR Form 1701/1701A', 'BIR Form 2550Q'],
    );
    vector(
      'OSD under VAT',
      EntityType.soleProp, VatStatus.vat, TaxRegime.graduatedOsd,
      nti: 1800000, incomeTax: 352500, businessTax: 0, netIncome: 847500,
      forms: <String>['BIR Form 1701Q', 'BIR Form 1701/1701A', 'BIR Form 2550Q'],
    );
  });
  ...
  group('partnership, taxed at the flat 20 percent CREATE rate', () {
    vector(
      ...
      EntityType.partnership, VatStatus.nonVat, TaxRegime.graduatedOsd,
      nti: 1080000, incomeTax: 216000, businessTax: 90000, netIncome: 894000,
      forms: <String>['BIR Form 1702Q', 'BIR Form 1702-RT/EX', 'BIR Form 2551Q'],
    );
    vector(
      'itemized',
      EntityType.partnership, VatStatus.nonVat, TaxRegime.graduatedItemized,
      nti: 1110000, incomeTax: 222000, businessTax: 90000, netIncome: 888000,
      forms: <String>['BIR Form 1702Q', 'BIR Form 1702-RT/EX', 'BIR Form 2551Q'],
    );
    vector(
      'the 8 percent regime does NOT apply to a partnership, only its form list changes',
      EntityType.partnership, VatStatus.nonVat, TaxRegime.eightPercent,
      nti: 1200000, incomeTax: 240000, businessTax: 0, netIncome: 960000,
  ...
  group('the rules behind the numbers', () {
    test('a VAT registered business never carries percentage tax', () {
      for (final TaxRegime r in TaxRegime.values) {
        for (final EntityType e in EntityType.values) {
          expect(run(e, VatStatus.vat, r).businessTax, 0,
    ...
    test('every other non-VAT combination charges 3 percent of gross sales',
        () {
      ...
      for (final TaxRegime r in TaxRegime.values) {
        for (final EntityType e in EntityType.values) {
          for (final VatStatus v in VatStatus.values) {
            final BusinessTaxResult res = run(e, v, r);
            final bool filesPercentageTax = res.complianceForms
                .any((ComplianceForm f) => f.form == 'BIR Form 2551Q');
            expect(filesPercentageTax, res.businessTax > 0,
