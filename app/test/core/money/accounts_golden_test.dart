...
import 'package:salapify/core/money/accounts_calc.dart';

void main() {
  final g =
      jsonDecode(File('test/goldens/accounts_goldens.json').readAsStringSync())
          as Map<String, dynamic>;

  test('round2 matches RN Math.round(x*100)/100', () {
    for (final c in (g['round2'] as List).cast<Map<String, dynamic>>()) {
      expect(
        round2((c['x'] as num).toDouble()),
