...
void main() {
  ...
  group('one-time buy verdicts', () {
    ...
    test(
      'a buy past spendable cash but within total money dips the cushion',
      () {
  ...
  group('honest degradation and guards', () {
    ...
    test('a one-time buy still gets a verdict with thin income history', () {
      ...
      final r = affordCheck(data, ref, mode: AffordMode.oneTime, amount: 5000);
    ...
    test(
      'the first payment not fitting spendable cash bumps up the verdict',
      () {
